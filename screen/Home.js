...
export default class Home extends Component {
    ...
    addData(data) {
        ...
        fetch('https://jsonplaceholder.typicode.com/posts', {
            method: 'POST',
            body: JSON.stringify({
                title: this.state.discription,
                body: this.state.amount,
                userId: this.state.type,
            }),
            headers: {
    ...
    getAllData() {
        fetch('http://192.168.1.2:3000/api/v1/incomeExpenseRoute/getAll', {
            method: 'POST',
            body: JSON.stringify({
    ...
    addTranscation() {
        fetch('http://192.168.1.2/api/v1/incomeExpenseRoute/add', {
            method: 'POST',
            body: JSON.stringify({
